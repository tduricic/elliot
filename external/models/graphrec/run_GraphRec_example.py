...
def get_top_k_recommendations(model, device, target_users, candidate_items, target_users_items, k):
    model.eval()
...
data_file)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # target_users_recommendations = get_top_k_recommendations(graphrec, device, target_users, candidate_items, target_users_items, args.k)
